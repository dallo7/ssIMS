...
layout = dmc.Stack(
    [
        ...
        dmc.Group(
            [
                dmc.Title("Purchase orders", order=3),
                dmc.Button("Refresh", id="po-refresh", variant="light"),
            ],
        ...
        dmc.SimpleGrid(
            ...
            children=[
                dmc.Card(
                    ...
                    padding="md",
                    children=[
                        dmc.Text("New draft PO", fw=600, mb="xs"),
                ...
                dmc.Card(
                    ...
                    padding="md",
                    children=[
                        dmc.Text("Workflow (selected row)", fw=600, mb="xs"),
